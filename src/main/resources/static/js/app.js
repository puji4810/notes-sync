...
const App = {
    ...
    methods: {
        ...
        loadRepositories() {
            ...
            axios.get('/api/v1/repositories')
                ...
                .catch(error => {
                    ...
                    this.$notify.error({
                        title: '错误',
                        message: '获取仓库列表失败: ' + (error.response?.data?.error || error.message)
                    });
                })
                .finally(() => {
                    this.loading = false;
        ...
        // 添加新仓库
        addRepository() {
            axios.post('/api/v1/repositories', this.newRepo)
                .then(response => {
                    if (response.data.success) {
                        this.$notify({
                            title: '成功',
                ...
                .catch(error => {
                    ...
                    this.$notify.error({
                        title: '错误',
                        message: '添加仓库失败: ' + (error.response?.data?.error || error.message)
                    });
                });
        },
        ...
        syncRepo(repo) {
            ...
            axios.post(`/api/v1/repositories/${repo.alias}/sync`)
                .then(response => {
                    if (response.data.success) {
                        this.$notify({
                            title: '成功',
                ...
                .catch(error => {
                    ...
                    this.$notify.error({
                        title: '错误',
                        message: '同步仓库失败: ' + (error.response?.data?.error || error.message)
                    });
                })
                .finally(() => {
                    this.loading = false;
        ...
        deployRepo(repo) {
            ...
            axios.post(`/api/v1/repositories/${repo.alias}/deploy`)
                .then(response => {
                    if (response.data.success) {
                        this.$notify({
                            title: '成功',
                ...
                .catch(error => {
                    ...
                    this.$notify.error({
                        title: '错误',
                        message: '部署仓库失败: ' + (error.response?.data?.error || error.message)
                    });
                })
                .finally(() => {
                    this.loading = false;
        ...
        // 更新仓库
        updateRepository() {
            axios.put(`/api/v1/repositories/${this.editingRepo.originalAlias}`, {
                ...
                .catch(error => {
                    ...
                    this.$notify.error({
                        title: '错误',
                        message: '更新仓库失败: ' + (error.response?.data?.error || error.message)
                    });
                });
        },
        ...
        cloneRepo(repo) {
            ...
            axios.post(`/api/v1/repositories/${repo.alias}/clone`)
                .then(response => {
                    if (response.data.success) {
                        this.$notify({
                            title: '成功',
                ...
                .catch(error => {
                    ...
                    this.$notify.error({
                        title: '错误',
                        message: '克隆仓库失败: ' + (error.response?.data?.error || error.message)
                    });
                })
                .finally(() => {
                    this.loading = false;
        ...
        commitAndPush() {
            ...
            axios.post(`/api/v1/repositories/${this.commitInfo.repoAlias}/commit-push`, {
        ...
        // 删除仓库
        deleteRepo(repo) {
            axios.delete(`/api/v1/repositories/${repo.alias}`)
                .then(response => {
                    if (response.data.success) {
                        this.$notify({
                            title: '成功',
                ...
                .catch(error => {
                    ...
                    this.$notify.error({
                        title: '错误',
                        message: '删除仓库失败: ' + (error.response?.data?.error || error.message)
                    });
                });
        },
        ...
        loadState() {
            if (this.appState && this.appState.userSettings) {
                this.commitInfo.authorName = this.appState.userSettings.authorName || '';
                this.commitInfo.authorEmail = this.appState.userSettings.authorEmail || '';
            }
        }
    }
};
